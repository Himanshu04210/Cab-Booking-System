...
//                            .requestMatchers("/hello").permitAll()
                        ...
                        .requestMatchers("/api/cabBooking/driver","/api/drivers/", "/api/driver/profile").hasAnyRole("DRIVER")
                        .requestMatchers(HttpMethod.PATCH,"/api/users/**","/api/wallets/**").hasAnyRole("USER")
//                        .requestMatchers("/WALLET/**", "/cabBooking/user").hasRole("USER")
